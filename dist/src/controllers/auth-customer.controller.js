...
var AuthController = /** @class */ (function () {
    ...
    AuthController.login = function () {
        ...
        this.loginController = function (req, resp) { return __awaiter(_this, void 0, void 0, function () {
            var _a, email, password, roles, customerExist, oKPassword, token, error_1;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        _b.trys.push([1, 3, , 4]);
                        return [4 /*yield*/, this.Customer.findOne({ email: email })];
                    case 2:
                        ...
                        oKPassword = customerExist.comparePassword(password, customerExist.password);
                        if (!oKPassword) {
                            return [2 /*return*/, resp.json({
                                    msg: '**Wrong credentials**',
                                    ok: true,
    ...
    AuthController.register = function () {
        ...
        this.registerController = function (req, resp) { return __awaiter(_this, void 0, void 0, function () {
            var _a, name, email, password, address, phone, location, newCustomer, userRegistred, error_2;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _a = req.body, name = _a.name, email = _a.email, password = _a.password, address = _a.address, phone = _a.phone, location = _a.location;
                        newCustomer = new this.Customer();
    ...
    AuthController.Customer = Customer_model_1.customerModel;
